...
int main () {
  ...
  fstream myfile ("record/pid_record.txt");
  ofstream outfile1;
  ofstream outfile2;
  ofstream outfile3;
  ofstream outfile4;

  outfile1.open ("feedback.txt",ios::in|ios::trunc);
  outfile2.open ("kp_term.txt",ios::in|ios::trunc);
  outfile3.open ("ki_term.txt",ios::in|ios::trunc);
  outfile4.open ("kd_term.txt",ios::in|ios::trunc);
  ...
  if (myfile.is_open() && outfile1.is_open() && outfile2.is_open())
  {
	...
	ss>>tmp1;ss>>tmp2;ss>>tmp3;ss>>tmp4;
        outfile1<<tmp1<<endl;
        outfile2<<tmp2<<endl;
        outfile3<<tmp3<<endl;
        outfile4<<tmp4<<endl;
